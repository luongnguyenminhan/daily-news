...
export function ArticleCard({
  ...
  return (
    <article className="group relative min-h-[100px] rounded-[11px] border border-[#202b3b] bg-[#0e1521]/65 transition-colors hover:border-[#35435a]">
      <a
        href={article.url}
        target="_blank"
        rel="noreferrer"
        className="grid min-h-[100px] grid-cols-[50px_minmax(0,1fr)] items-center gap-3 rounded-[11px] px-[18px] py-[16px] pr-[55px] text-inherit no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8568ff] focus-visible:ring-inset sm:min-h-[111px] sm:grid-cols-[68px_minmax(0,1fr)_255px] sm:gap-[17px] sm:px-[22px] sm:py-[18px] sm:pr-[74px]"
      >
